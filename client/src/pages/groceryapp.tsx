    ...
    return (
        <div className="flex flex-col min-h-screen bg-gray-800">
            <Head>
                ...
                <meta name="description" content="A grocery list app with dynamic theme selection and Firebase integration" />
            </Head>
            ...
            <div className="description-section bg-gradient-to-r from-blue-900 to-purple-900 text-white py-8 px-4 md:px-8 mt-20">
                <div className="max-w-5xl mx-auto">
                    <h1 className="text-3xl md:text-4xl font-bold mb-4">Grocery List App</h1>
                    <p className="text-lg mb-4">
                        A grocery list app that helps you manage, share, and organize your grocery shopping with seven interactive screens. 
                        It features dynamic theme selection and integrates Firebase for real-time data storage and syncing.
                    </p>
                    <div className="grid md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <ul className="list-disc list-inside space-y-1 ml-2">
                                ...
                                <li>Dynamic theme selection for personalized user experience</li>
                        ...
                        <div>
                            ...
                            <li>Android Studio for development and testing using a virtual device</li> {/* Added Android Studio */}
                ...
                <div className="max-w-7xl mx-auto bg-gray-700 text-white rounded-lg shadow-lg overflow-hidden mt-6">
                    ...
                    <div className="flex mb-8">
                        ...
                        <div className="w-2/3 pl-8">
                            <h2 className="text-xl font-semibold mb-2">Technology Overview:</h2>
                            <p className="text-lg mb-4">
                            ...
                            <ul className="list-disc list-inside space-y-1 ml-2">
                                ...
                                <li><strong>Persistency:</strong> User inputs like theme selection and list information are stored to ensure data is preserved even when the app is closed or the device is rotated.</li>
                                <li><strong>Real-Time Feedback:</strong> The app provides users with immediate feedback on their actions using Toast messages for adding items or changing themes, ensuring a responsive and interactive experience.</li>
                            </ul>
                        </div>
                    </div>
