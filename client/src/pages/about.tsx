            ...
            <div className="pt-24 px-4 md:px-10 pb-8">
                <div className="max-w-3xl mx-auto">
                    <div className="bg-gray-800 rounded-lg p-6 mb-8">
                        <h1 className="text-center text-4xl mb-4 text-white" style={{ fontFamily: 'Times New Roman, Times, serif' }}>About Me</h1>
                            ...
                            <div className="flex flex-col space-y-2 text-white">
                                ...
                                <label className="flex items-center space-x-2">
                                    <input
                                        ...
                                        onChange={(e) => setReason(e.target.value)}
                                    />
                                    <span>You're trying to get in touch with me and it's urgent</span>
                                </label>
                                <label className="flex items-center space-x-2">
                                    <input
                                        type="radio"
