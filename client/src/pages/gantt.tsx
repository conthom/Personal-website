...
export default function Gantt() {
    ...
    useEffect(() => {
        ...
        const updateIframeHeight = () => {
            ...
            const headerHeight = headerElement ? (headerElement as HTMLElement).offsetHeight : 80;
            const descriptionHeight = descriptionElement ? (descriptionElement as HTMLElement).offsetHeight : 220;
            
            // Add extra padding to ensure enough space
            setIframeHeight(`calc(100vh - ${headerHeight + descriptionHeight + 40}px)`);
        };
    ...
    return (
        <div className="flex flex-col min-h-screen bg-gray-800">
            <Head>
                <title>G4NTT - AI Business Action Plan Generator | Connor Thompson</title>
                <link rel="icon" href="/connor logo.png" />
                <meta name="description" content="G4NTT - AI-powered business action plan generator with Gantt chart visualization" />
            </Head>
            ...
            <div className="description-section bg-gradient-to-r from-blue-800 to-indigo-900 text-white py-8 px-4 md:px-8 mt-20">
                <div className="max-w-5xl mx-auto">
                    <h1 className="text-3xl md:text-4xl font-bold mb-4">G4NTT - AI Business Action Plan Generator</h1>
                    ...
                    <div className="mb-6">
                        <div className="md:flex md:gap-10">
                            ...
                            <div className="md:w-2/3 md:mt-0">
                                ...
                                <div className="relative w-full" style={{ height: "500px", width: "150%" }}>
                                    <Image 
