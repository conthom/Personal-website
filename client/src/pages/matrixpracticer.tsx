    ...
    return (
        <div className="flex flex-col min-h-screen bg-gray-800">
            <Head>
                ...
                <meta name="description" content="Matrix Practice tool for linear algebra calculations" />
            </Head>
            ...
            <div className="description-section bg-gradient-to-r from-blue-900 to-purple-900 text-white py-8 px-4 md:px-8 mt-20">
                <div className="max-w-5xl mx-auto">
                    <h1 className="text-3xl md:text-4xl font-bold mb-4">Matrix Reduction Practice</h1>
